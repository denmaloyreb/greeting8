...
var greetings = []string{
	...
	"Поздравляю с 8 Марта! Будьте счастливы, любимы и неповторимы!",
	...
	"С 8 Марта! Желаю счастья, крепкого здоровья и исполнения желаний!",
	// Добавленные поздравления (11–20)
	"С 8 Марта! Пусть в вашей душе всегда цветёт весна!",
	"Поздравляю c 8 Марта! Сияйте, как весеннее солнце!",
	"С праздником весны, любви и красоты! Будьте счастливы!",
	"С 8 Марта! Желаю нежности, тепла и приятных сюрпризов каждый день!",
	"Пусть этот день подарит вам море улыбок и цветов. С 8 Марта!",
	"С 8 Марта! Оставайтесь всегда такой же прекрасной и вдохновляющей!",
	"Поздравляю с Международным женским днём! Пусть сбываются мечты!",
	"С 8 Марта! Желаю радости, весеннего тепла и счастья!",
	"С праздником! Пусть жизнь будет наполнена любовью и гармонией.",
	"С 8 Марта! Желаю, чтобы каждый день приносил только приятные эмоции!",
	// Добавленные поздравления (21–32)
	"С 8 Марта! Пусть ваша красота расцветает с каждым днём!",
	"Поздравляю с праздником весны! Желаю вдохновения и новых свершений!",
	"С 8 Марта! Пусть в сердце живёт любовь, а в доме — уют и тепло!",
	"С Международным женским днём! Желаю ярких красок в жизни!",
	"С 8 Марта! Будьте любимы и счастливы каждый миг!",
	"Поздравляю! Пусть весна подарит вам много поводов для улыбок!",
	"С 8 Марта! Желаю, чтобы все ваши желания исполнялись легко и быстро!",
	"С 8 Марта! Оставайтесь королевой своего счастья!",
	"С 8 Марта! Пусть вокруг будет только доброта, забота и внимание!",
	"Поздравляю с Международным женским днём! Желаю море позитива!",
